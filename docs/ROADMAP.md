...
- [x] Bounded 404 retry for the dedicated download host's propagation delay after upload ([#20](https://github.com/sprintberlin/zoho-attachment-bridge/issues/20))
